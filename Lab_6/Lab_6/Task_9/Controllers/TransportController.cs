...
namespace Task_9.Controllers
{
    public class TransportController : Controller
    {
        ...
        // GET: Transport/Details/5 – деталі маршруту
        ...
        // GET: Transport/Create – форма додавання маршруту
        ...
        public async Task<IActionResult> Create([Bind("Id,VidTransportu,NomMarshruta,ProtjazhnistMarshruta,ChasVDorozi,KilkistZupynok")] Transport transport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VidTransportu,NomMarshruta,ProtjazhnistMarshruta,ChasVDorozi,KilkistZupynok")] Transport transport)
        {
            if (id != transport.Id)
                return NotFound();
